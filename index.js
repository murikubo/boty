...
client.on('message', message => {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('가챠') === message.content.search(prefix) + 1) {
            SR_COUNT = '0';
            let j = 0;
            if (skip == 0) { //비 생략모드
                if (CindeFest == '1') {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('페스') === message.content.search(prefix) + 1) {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('생략') === message.content.search(prefix) + 1) {
            if (skip == '0') {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('전부') === message.content.search(prefix) + 1) {
            if (skip == '1') {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('한정') === message.content.search(prefix) + 1) {
    ...
    if (message.content.search(prefix) != -1 && message.content.search(prefix) === 0) {
        if (message.content.search('통상') === message.content.search(prefix) + 1) {
