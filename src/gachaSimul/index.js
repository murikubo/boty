                    ...
                    .then(() => {
                        ...
                        message.channel.awaitMessages(filter, {
                            ...
                            .then((collected) => {
                                ...
                                content.push({
                                    name: `1라운드`,
                                    value: `${userSSR[message.author.id][0]} vs ${userSSR[memberArray[message.guild.id].memberList[selectedList].userId][0]}`
                                });
                                message.channel.send({
                                    embed: {
                                        title: `대전 결과 - ${message.author.GuildMember.nickname} vs ${memberArray[message.guild.id].memberList[selectedList].userNickName}`,
                                        color: '3447003',
                                        fields: content,
                                        timestamp: new Date(),
                                        footer: {
